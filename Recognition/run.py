...
def loop_and_detect(cam, trt_yolo, conf_th, vis):
    ...
    while True:
        ...
        try:
            ...
            image_segmentation = road_lines(copyImage, session=session_lane,
                                            inputname=input_name_lane)  # hàm detect làn đường trả về ảnh đã detect, góc lái, với điểm center dự đoán
            ...
            if (
                    len(centers) > 0):  # nếu phát hiện đối tượng
